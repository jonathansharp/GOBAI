...
train_gobai('FFNN',param,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_train,snap_date,'reduce_data',...
    data_per,'train_ratio',train_ratio,'val_ratio',val_ratio,...
    'test_ratio',test_ratio,'num_folds',num_folds);
% random forest regressions
train_gobai('RFR',param,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_train,snap_date,'reduce_data',...
    data_per,'numtrees',numtrees,'minLeafSize',minLeafSize,...
    'num_folds',num_folds);
% gradient-boosting machines
train_gobai('GBM',param,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_train,snap_date,'reduce_data',...
...
% feed-forward neural networks
predict_gobai('FFNN',param,pwd,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_predict,2004,...
...
% random forest regressions
predict_gobai('RFR',param,pwd,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_predict,2004,...
...
% gradient-boosting machines
predict_gobai('GBM',param,pwd,base_grid,file_date,float_file_ext,...
    num_clusters,variables,param_props,thresh,numWorkers_predict,2004,...
