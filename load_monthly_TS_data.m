...
function TS = load_monthly_TS_data(fpaths,base_grid,m,w,start_year,end_year,date_str)
...
elseif strcmp(base_grid,'RFROM')
    ...
    nc_filepath_cns_tmp = [fpaths.model_path base_grid ...
        '/combined/regridded/cns_tmp' path2 ...
        'combined' path3 '_' num2str(start_year) '01-' date_str '.nc'];
    % load dimensions
