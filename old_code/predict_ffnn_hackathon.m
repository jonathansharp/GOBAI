...
p=profile('info');
profsave(p,'profiles/predict_ffnn_hackathon')
profile off
...
function apply_ffnn_model(TS,num_clusters,ffnn_dir,ffnn_fnames,...
    base_grid,m,w,xdim,ydim,zdim,variables_TS,thresh,gobai_ffnn_dir,fpath)
    ...
    % apply models for just the first cluster
    c = 1;
