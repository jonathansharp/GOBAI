...
function [TS,months,weeks,timesteps] = load_climatological_TS_data(fpath,base_grid,start_year,date_str)
...
elseif strcmp(base_grid,'RFROM')
    ...
    [TS,weeks,timesteps] = load_model_dim(nc_filepath_abs_sal);
