...
function run_osse(fpaths,model_types,model_folders,realizations,...
    grid_labels,grid_types,param_props,base_grid,...
    file_date,snap_date,glodap_vrs,float_file_ext,start_year,...
    end_year,num_clusters,variables,clust_vars,train_ratio,val_ratio,...
    test_ratio,thresh,data_per_osse,numWorkers_train,numWorkers_predict,...
    flt,gld,osd,ctd)
...
for m = 1:length(model_types)
    ...
    gmm_clustering(param_props,fpaths,model_types{m},...
        ...
        numWorkers_predict,flt,gld,osd,ctd,'rlz',realizations{m});

    %% cluster data
    assign_data_to_clusters(param_props,model_types{m},snap_date,...
        float_file_ext,clust_vars,num_clusters,flt,gld,osd,ctd);
    plot_data_by_cluster(param_props,model_types{m},file_date,...
        float_file_ext,num_clusters,numWorkers_train,flt,gld,osd,ctd);
    ...
    train_gobai('FFNN',param_props,model_types{m},file_date,float_file_ext,...
        ...
        flt,gld,osd,ctd,'reduce_data',data_per_osse,'train_ratio',...
    ...
    predict_gobai('FFNN',param_props,fpaths,...
        ...
        snap_date,flt,gld,osd,ctd,'train_ratio',train_ratio,'val_ratio',val_ratio,...
        'test_ratio',test_ratio,'rlz',realizations{m},'reduce_data',data_per_osse);
    ...
    compare_osse(param_props,fpaths,...
        ...
        val_ratio,test_ratio,data_per_osse,realizations{m},...
        float_ext,glodap_ext,osd_ext,ctd_ext,numWorkers_predict);

end

%% compare all osse experiments
compare_all_osses(param_props,fpaths,model_types,realizations,...
    num_clusters,file_date,snap_date,float_file_ext,train_ratio,val_ratio,...
    test_ratio,float_ext,glodap_ext,osd_ext,ctd_ext);
