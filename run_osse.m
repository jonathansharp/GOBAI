...
for m = 1:length(model_types)
    ...
    predict_gobai('FFNN',param,['/raid/Model/CMIP6/' model_folders{m} '/'],...
        ...
        'rlz','r1i1p1f1','grid_label','gr','grid_type','regridded');
    ...
    compare_osse_to_model(param,param1,['/raid/Model/CMIP6/' model_folders{m} '/'],...
        model_types{m},file_date,float_file_ext,...
        num_clusters,2004,snap_date,'r1i1p1f1','gr','regridded');
