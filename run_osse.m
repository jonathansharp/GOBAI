...
function run_osse(param,file_date,snap_date,float_file_ext,...
...
for m = 1:length(model_types)
    ...
    %% process models
    process_cmip_model(model_types{m},['/raid/Model/CMIP6/' model_folders{m} '/'],...
        snap_date,2004,realizations{m},grid_labels{m},grid_types{m});

    %% subsample models
    subsample_cmip_model(param,all_data,model_types{m},...
        ['/raid/Model/CMIP6/' model_folders{m} '/'],file_date,...
        snap_date,float_file_ext,2004,realizations{m});
  
    %% form clusters
    gmm_clustering(param,['/raid/Model/CMIP6/' model_folders{m} '/'],model_types{m},...
        2004,snap_date,file_date,float_file_ext,clust_vars,num_clusters,numWorkers_predict);
    ...
    combine_gobai(param,['/raid/Model/CMIP6/' model_folders{m} '/'],...
    ...
    compare_osse(param,param1,['/raid/Model/CMIP6/' model_folders{m} '/'],...
        model_types{m},file_date,float_file_ext,...
        num_clusters,2004,snap_date,train_ratio,...
        val_ratio,test_ratio,numtrees,minLeafSize,...
