...
for m = 1:length(model_types)
    ...
    % gmm_clustering(param_props,[model_path model_folders{m} '/'],...
    %     [model_path model_folders{m} '/'],model_types{m},...
    %     start_year,end_year,snap_date,float_file_ext,clust_vars,num_clusters_1,...
    %     numWorkers_predict,[model_path model_folders{m} '/'],'rlz',realizations{m});
    % gmm_clustering(param_props,[model_path model_folders{m} '/'],...
    %     [model_path model_folders{m} '/'],model_types{m},...
    %     start_year,end_year,snap_date,float_file_ext,clust_vars,num_clusters_2,...
    %     numWorkers_predict,[model_path model_folders{m} '/'],'rlz',realizations{m});
    % gmm_clustering(param_props,[model_path model_folders{m} '/'],...
    %     [model_path model_folders{m} '/'],model_types{m},...
    %     start_year,end_year,snap_date,float_file_ext,clust_vars,num_clusters_3,...
    %     numWorkers_predict,[model_path model_folders{m} '/'],'rlz',realizations{m});
    ...
    % assign_data_to_clusters(param_props,model_types{m},snap_date,float_file_ext,clust_vars,num_clusters_1);
    % plot_data_by_cluster(param_props,model_types{m},file_date,float_file_ext,num_clusters_1,numWorkers_train);
    % assign_data_to_clusters(param_props,model_types{m},snap_date,float_file_ext,clust_vars,num_clusters_2);
    % plot_data_by_cluster(param_props,model_types{m},file_date,float_file_ext,num_clusters_2,numWorkers_train);
    % assign_data_to_clusters(param_props,model_types{m},snap_date,float_file_ext,clust_vars,num_clusters_3);
    % plot_data_by_cluster(param_props,model_types{m},file_date,float_file_ext,num_clusters_3,numWorkers_train);
    ...
    % train_gobai('RFR',param_props,model_types{m},file_date,float_file_ext,...
    %     num_clusters,tree_variables,thresh,numWorkers_train,snap_date,'reduce_data',...
    %     data_per,'numtrees',numtrees,'minLeafSize',minLeafSize);
    % % train gradient-boosting machines
    % train_gobai('GBM',param_props,model_types{m},file_date,float_file_ext,...
    %     num_clusters,tree_variables,thresh,numWorkers_train,snap_date,'reduce_data',...
    ...
    % predict_gobai('RFR',param_props,[model_path model_folders{m} '/'],...
    %     [model_path model_folders{m} '/'],[model_path model_folders{m} '/'],...
    %     model_types{m},file_date,float_file_ext,num_clusters,...
    %     tree_variables,thresh,numWorkers_predict,clust_vars,start_year,end_year,...
    %     snap_date,'numtrees',numtrees,'minLeafSize',minLeafSize,...
    %     'rlz',realizations{m});
    % % predict on grid using gradient-boosting machines
    % predict_gobai('GBM',param_props,[model_path model_folders{m} '/'],...
    %     [model_path model_folders{m} '/'],[model_path model_folders{m} '/'],...
    %     model_types{m},file_date,float_file_ext,num_clusters,...
    %     tree_variables,thresh,numWorkers_predict,clust_vars,start_year,end_year,...
