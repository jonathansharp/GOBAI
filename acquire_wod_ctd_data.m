function wod = acquire_wod_ctd_data(param,glodap_year)
...
folder = '/raid/sharp/matlab/O2_Intercomparison/WOD_Profiles_data';
types = {'CTD'};
...
exportgraphics(gcf,[param1 '/Figures/Data/processed_wod_ctd_filtered_' year '.png']);
close
clear lon_temp
...
disp(['# of matching CTD Casts (' param5 '): ' num2str(length(unique(wod_data.ID)))]);
disp(['# of matching Cruises (' param5 '): ' num2str(length(unique(wod_data.CRU)))]);

%% save processed ctd data
if ~exist([pwd '/' param1 '/Data'],'dir'); mkdir([param1 '/Data']); end
save([param1 '/Data/processed_wod_ctd_' param '_data_' year '.mat'],...
    'wod_data','-v7.3');
