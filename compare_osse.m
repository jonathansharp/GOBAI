...
function compare_osse(param_props,fpaths,base_grid,file_date,...
    ...
    val_ratio,test_ratio,data_per_osse,rlz,float_ext,glodap_ext,osd_ext,ctd_ext,...
...
osse_filepath = ...
    [fpaths.param_path 'GOBAI/' base_grid '/FFNN/c' ...
        ...
        num2str(100*test_ratio) '/' float_ext glodap_ext osd_ext ctd_ext coverage ...
        '/GOBAI-' param_props.dir_name '-HR-v' date_str '.nc'];
% cmip
...
for r = 1:length(regions)
    ...
    export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
            '/total_comp_' regions{r} '_' float_ext glodap_ext osd_ext ctd_ext ...
            '_c' num2str(num_clusters) '_' ...
            num2str(data_per_osse) 'per.png']); close;
    % for seasonal
    ...
    legend({base_grid ['GOBAI-' param_props.dir_name '_{(' base_grid ')}']});
    export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
            '/seas_comp_' regions{r} '_' float_ext glodap_ext osd_ext ctd_ext ....
            '_c' num2str(num_clusters) '_' ...
            num2str(data_per_osse) 'per.png']); close;
    % for trend
    ...
    legend({base_grid ['GOBAI-' param_props.dir_name '_{(' base_grid ')}']});
    export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
            '/trend_comp_' regions{r} '_' float_ext glodap_ext osd_ext ctd_ext ...
            '_c' num2str(num_clusters) '_' ...
            num2str(data_per_osse) 'per.png']); close;
    % for residual
    ...
    legend({base_grid ['GOBAI-' param_props.dir_name '_{(' base_grid ')}']});
    export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
            '/resid_comp_' regions{r} '_' float_ext glodap_ext osd_ext ...
            ctd_ext '_c' num2str(num_clusters) '_' ...
            num2str(data_per_osse) 'per.png']); close;
end
...
colormap(cmocean('balance'));
export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
        '/gobai_col_mean_trend_' float_ext glodap_ext osd_ext ctd_ext ...
        '_c' num2str(num_clusters) '_' ...
        num2str(data_per_osse) 'per.png'],'-transparent'); close;
close
...
colormap(cmocean('balance'));
export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
        '/model_col_mean_trend_' float_ext glodap_ext osd_ext ctd_ext ...
        '_c' num2str(num_clusters) '_' ...
        num2str(data_per_osse) 'per.png'],'-transparent'); close;
close
...
save([param_props.dir_name '/Data/' base_grid '/' rlz '_gr/statistics_' ...
    float_ext glodap_ext osd_ext ctd_ext '_c' num2str(num_clusters) '_' ...
    num2str(data_per_osse) 'per.mat'],...
...
% end
% export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
%         '/timeseries_' float_ext glodap_ext osd_ext ctd_ext '.png'],'-transparent'); close;
...
export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
        '/profile_' float_ext glodap_ext osd_ext ctd_ext '_c' num2str(num_clusters) '_' ...
        num2str(data_per_osse) 'per.png'],'-transparent'); close;
...
ylabel('Depth (m)');
export_fig(gcf,[param_props.dir_name '/Figures/' base_grid '/' rlz '_gr' ...
        '/profile_delta_' float_ext glodap_ext osd_ext ctd_ext '_c' ...
        num2str(num_clusters) '_' num2str(data_per_osse) 'per.png'],'-transparent'); close;
