...
function predict_rfr(param,dir_base,base_grid,file_date,float_file_ext,...
    num_clusters,variables,numtrees,minLeafSize,thresh,numWorkers_predict,...
    years_to_predict)
...
parfor m = m1:m2
    if strcmp(base_grid,'RG')
        ...
        apply_rfr_model(TS,num_clusters,rfr_dir,rfr_fnames,...
            ...
            thresh,gobai_rfr_dir,param,units,long_param_name);
    elseif strcmp(base_grid,'RFROM')
        % load dimensions
