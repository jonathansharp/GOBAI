%% plot GOBAI-NO3 data in 3D

% file paths
fname = 'Figures/3d_gobai_nitrate_animation.gif';
...
% load dimensions
lon = ncread('/raid/Data/GOBAI-NO3/v1.0/GOBAI-NO3-v1.0.nc','lon');
lat = ncread('/raid/Data/GOBAI-NO3/v1.0/GOBAI-NO3-v1.0.nc','lat');
pres = ncread('/raid/Data/GOBAI-NO3/v1.0/GOBAI-NO3-v1.0.nc','pres');
...
for y = 2004:2024
    for m = 1:12
        % load gobai
        gobai = ncread('/raid/Data/GOBAI-NO3/v1.0/GOBAI-NO3-v1.0.nc','nitrate',...
