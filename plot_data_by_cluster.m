...
function plot_data_by_cluster(param_props,base_grid,file_date,...
    float_file_ext,num_clusters,numWorkers_predict,flt,gld,ctd,varargin)
...
parfor p = 1:length(pressures)
    ...
    export_fig(gcf,[dname '/clustered_data' coverage '_' float_ext glodap_ext ctd_ext ...
    ...
    for clst = 1:num_clusters
        ...
        export_fig([dname '/clustered_data_probability' ...
            ...
            ctd_ext '_' num2str(pressures(p)) '.png'],...
            '-transparent','-silent');
        close
    end
end
