...
hold off;
exportgraphics(gcf,['O2/Figures/Data/mean_float_profile_' file_date float_file_ext '.png']);
close
...
set(gca,'YDir','reverse');
hold off;
exportgraphics(gcf,['O2/Figures/Data/mean_glodap_profile_' num2str(glodap_year) '.png']);
close
...
set(gca,'YDir','reverse');
hold off;
exportgraphics(gcf,['O2/Figures/Data/all_float_profiles_' file_date float_file_ext '.png']);
close
% clean up
...
if ~exist([pwd '/O2/Figures'],'dir'); mkdir('O2/Figures'); end
if ~exist([pwd '/O2/Figures/Data'],'dir'); mkdir('O2/Figures/Data'); end
exportgraphics(gcf,['O2/Figures/Data/data_by_year_' file_date float_file_ext '.png']);
...
if ~exist([pwd '/O2/Figures/Data'],'dir'); mkdir('O2/Figures/Data'); end
exportgraphics(gcf,['O2/Figures/Data/data_by_latitude_' file_date float_file_ext '.png']);
clear edges
close
...
if ~exist([pwd '/O2/Figures/Data'],'dir'); mkdir('O2/Figures/Data'); end
exportgraphics(gcf,['O2/Figures/Data/data_by_longitude_' file_date float_file_ext '.png']);
clear edges
close
